...
class DsaQuize extends StatefulWidget {
  const DsaQuize({Key? key}) : super(key: key);

  @override
  _DsaQuizeState createState() => _DsaQuizeState();
}

class _DsaQuizeState extends State<DsaQuize> {
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Data Structures algoritham"),
